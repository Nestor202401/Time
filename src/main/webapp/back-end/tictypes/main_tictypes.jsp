         ...
         <li class="sidebar-item"><a class="sidebar-link" href="index.html"> 
          ...
          <li class="sidebar-item active"><a class="sidebar-link" href="#formsDropdown" aria-expanded="aria-expanded" data-bs-toggle="collapse"> 
            ...
            <ul class="collapse list-unstyled show" id="formsDropdown">
              <li class="active"><a class="sidebar-link" href="#">電影設定</a></li>
          ...
          <li class="sidebar-item active"><a class="sidebar-link" href="#tablesDropdown" aria-expanded="aria-expanded" data-bs-toggle="collapse"> 
              ...
              <ul class="collapse list-unstyled show" id="tablesDropdown">
                <li class="active"><a class="sidebar-link" href="../ticorder/main_ticorder.jsp">訂單管理</a></li>
                <li><a class="sidebar-link" href="main_tictypes.jsp">票種設定</a></li>
              </ul>
            </li>
