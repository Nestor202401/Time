       ...
       <ul class="list-unstyled">                  
          ...
          <li class="sidebar-item active"><a class="sidebar-link" href="#formsDropdown" aria-expanded="aria-expanded" data-bs-toggle="collapse"> 
            ...
            <ul class="collapse list-unstyled show" id="formsDropdown">
              ...
              <li class="active"><a class="sidebar-link" href="<%=request.getContextPath()%>/back-end/cinema/cinema.jsp">影廳管理</a></li>
            </ul>
          </li>
        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 py-3">
              ...
              <li class="breadcrumb-item active fw-light" aria-current="page">cinema  </li>
            </ol>
          </nav>
        </div>
      </div>
...
<jsp:include page="cinemaall.jsp" />
