       ...
       <ul class="list-unstyled">                  
          ...
          <li class="sidebar-item"><a class="sidebar-link" href="#formsDropdown" data-bs-toggle="collapse"> 
            ...
            <ul class="collapse list-unstyled " id="formsDropdown">
              <li><a class="sidebar-link" href="<%=request.getContextPath()%>/back-end/movie/movie.jsp">電影管理</a></li>
          ...
          <li class="sidebar-item active"><a class="sidebar-link" href="#tablesDropdown" aria-expanded="aria-expanded" data-bs-toggle="collapse"> 
                <svg class="svg-icon svg-icon-sm svg-icon-heavy me-2">
                  <use xlink:href="#portfolio-grid-1"> </use>
                </svg>票務相關設定 </a>
              <ul class="collapse list-unstyled show" id="tablesDropdown">
                <li class="active"><a class="sidebar-link" href="<%=request.getContextPath()%>/back-end/ticorder/main_ticorder.jsp">訂單管理</a></li>
                <li><a class="sidebar-link" href="../tictypes/main_tictypes.jsp">票種設定</a></li>
              </ul>
            </li>
