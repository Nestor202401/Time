...
<body>
   <header>
        <div class="container99">
            <div class="logo">
                <h1 style="color:white;">Time影城</h1>
            </div>
            <nav>
                <ul>
                    <li><a href="#">電影</a></li>
...
<div style="height:130px;"></div>
    <div style="position: relative; margin-bottom: 20px;margin-right: 20px;">
        <button id="addButton" class="edit-button" style="position: absolute; top: 0; right: 0;" onclick="location.href='<%=request.getContextPath()%>/front-end/article/addArticle.jsp'">新增文章</button>
    </div>
...
<%--                 <td>【${articleVO.typeId}】</td> --%>
                ...
                <td class="main-column">              
                    <a href="<%= request.getContextPath() %>/front-end/article/article.do?action=getOne_For_Display&articleId=${articleVO.articleId}">
...
<div class="footer">
    ...
    <div class="copyright">
        © 2024 Time娛樂股份有限公司 ( Entertainment, Inc.) 在此提及的所有 商標 是其各自所有人的財產。台灣商頁影城有限公司台灣分公司 28992446
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#ticketTable').DataTable({
                ...
                "columnDefs": [
                    { "className": "article-column", "targets": 1 }
                ]
            });
        });
    </script>
