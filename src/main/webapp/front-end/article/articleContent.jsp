	...
	<div class="container">
		<div class="article">
			...
			<div class="function-area">
				...
				<div style="vertical-align: middle; text-align: right;">
					<button type="button" class="home-button" onclick="window.location.href='<%=request.getContextPath()%>/front-end/article/home.jsp'">回到首頁</button>
					<button type="button" id="reportButton" style="background-color:red;">檢舉</button>
				</div>
			</div>
			<hr>
...
<!-- 			</div> -->
  	...
  	<div class="container">
		<div class="article">
			<h2>新 增 留 言</h2>
			<form action="<%=request.getContextPath()%>/front-end/comments/comments.do" method="post">
				<textarea id="commentContent" name="commentContent" rows="5"
					required></textarea>
				<input type="hidden" name="articleId" value="${ articleVO.articleId }">
				<input type="hidden" name="memberId" value="${memberId}"><!-- !!!! 記得改 -->
	...
	<form action="<%=request.getContextPath()%>/front-end/reports/reports.do" method="post">
		...
		<div>
			<label for="memberId">會員:</label> <input type="text" id="memberId"
				name="memberId" value="${memberId}" required> <!-- !!!! 記得改 -->
		</div>
